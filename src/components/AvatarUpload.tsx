    ...
    <Card className="bg-gray-900/50 border-cyan-500/20">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-xs text-gray-400 space-y-1">
          <p>• Foto akan di-compress otomatis untuk menghemat storage</p>
          <p>• Base64 encoding: tidak memerlukan file storage</p>
          <p>• Maksimal ukuran setelah compression: 500KB</p>
        </div>
      </CardContent>
    </Card>
  )
