  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={showManageDialog} onOpenChange={setShowManageDialog}>
        <DialogContent className="bg-gray-900 border-emerald-500/30 text-white max-w-2xl">
          <DialogHeader>
            <DialogTitle className="text-emerald-400">Manage Deposit Request</DialogTitle>
          </DialogHeader>
          {selectedDeposit && (
            <div className="space-y-6">
              {/* Deposit Info */}
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="text-gray-400">Deposit ID</Label>
                  <p className="text-white font-mono text-sm">{selectedDeposit.id}</p>
                </div>
                <div>
                  <Label className="text-gray-400">Amount</Label>
                  <p className="text-white font-medium">{formatRupiah(selectedDeposit.amount)}</p>
                </div>
                <div>
              ...
              {/* User Info */}
              <div>
                <Label className="text-gray-400">User Information</Label>
                <div className="mt-2 p-3 bg-black/40 rounded-lg">
                  <p className="text-white">{selectedDeposit.user.name}</p>
                  <p className="text-gray-400 text-sm">{selectedDeposit.user.email}</p>
                  <Badge className={cn("mt-1", getRoleColor(selectedDeposit.user.role))}>
              ...
              {selectedDeposit.proofUrl && (
                <div>
                  <Label className="text-gray-400">Payment Proof</Label>
                  <div className="mt-2">
                    <img 
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="mt-2 bg-black/40 border-gray-600 text-white placeholder-gray-400"
                  rows={3}
                />
              </div>
